...
import { IntersectionTableFiltersComponent } from 'pages/annotations/sample/table/intersection/filters/intersection-table-filters.component';
...
@NgModule({
    imports:         [ BrowserModule, ModalsModule, FormsModule, TableModule, ChartsModule ],
    declarations:    [
    ...
    entryComponents: [
        ...
        MatchesTableComponent,
        MatchesTableEntryAlignmentComponent ],
    providers:       [ SampleService, SampleChartService ]
})
