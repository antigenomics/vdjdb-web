...
object MotifsSearchTreeFilterResult {
  implicit val motifSearchTreeFilterResultFormat: Format[MotifsSearchTreeFilterResult] = Json.format[MotifsSearchTreeFilterResult]
}
