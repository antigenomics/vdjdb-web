...
case class SearchTableResultsResponse(page: Int, pageSize: Int, rows: List[SearchTableRow]) extends SuccessResponse(SearchTableResultsResponse.action)

object SearchTableResultsResponse {
    final val action: String = "api.database.search"
