...
i.e. the ability to recognize certain epitopes in certain MHC contexts.
...
we do our best to ensure data consistency and correct irregularities in TCR specificity reporting with a complex database validation scheme:
